...
public class UpsertCompiler {
    private static void setValues(byte[][] values, int[] pkSlotIndex, int[] columnIndexes,
            ...
            byte[][] viewConstants,
            Expression compare) throws SQLException {
    ...
    public MutationPlan compile(UpsertStatement upsert) throws SQLException {
        ...
        return new MutationPlan() {
            ...
            public MutationState execute() throws SQLException {
                ...
                setValues(values, pkSlotIndexes, columnIndexes, table, mutation, statement, useServerTimestamp, indexMaintainer, viewConstants, compare);
